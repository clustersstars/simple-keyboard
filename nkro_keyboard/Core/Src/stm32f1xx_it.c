...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(COL6_Pin);
  HAL_GPIO_EXTI_IRQHandler(COL7_Pin);
  HAL_GPIO_EXTI_IRQHandler(COL8_Pin);
  HAL_GPIO_EXTI_IRQHandler(COL9_Pin);
  HAL_GPIO_EXTI_IRQHandler(COL10_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(COL11_Pin);
  HAL_GPIO_EXTI_IRQHandler(COL12_Pin);
  HAL_GPIO_EXTI_IRQHandler(COL13_Pin);
  HAL_GPIO_EXTI_IRQHandler(COL14_Pin);
  HAL_GPIO_EXTI_IRQHandler(COL15_Pin);
  HAL_GPIO_EXTI_IRQHandler(COL16_Pin);
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin){
 ...
 void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim){
  ...
  if(htim == keyboard_tim_1ms){
    USBD_HID_SendReport(&hUsbDeviceFS,type_manage.report_manage->usb_report,NKRO_REPORT_BUFFER_SIZE);
  }
 }
